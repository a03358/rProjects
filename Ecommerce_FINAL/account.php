...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || MOBILE MART</title>
        ...
        <div class="small-12">
          ...
          <div class="row">
            ...
            <div class="small-8 columns end">
              ...
              echo '</div>';
              echo '<div class="small-8 columns end">';
              echo '<input type="password" id="pass" name="pwd">';

              echo '</div>';
              echo '</div>';	 
	      echo '<div class="row">';
	      echo '<div style="position:relative; left:265px">';
	      echo '<input type="checkbox" onclick="change()">';
	      echo '<label class="txt">Show Password</label>';
